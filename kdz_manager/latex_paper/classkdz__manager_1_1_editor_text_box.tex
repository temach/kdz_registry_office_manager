...
\begin{DoxyCompactList}\small\item\em Если мы сможем успешно связываться с Data\+Table (имеется в виду \end{DoxyCompactList}\item 
string {\bf Label}\hspace{0.3cm}{\ttfamily  [get, set]}
\begin{DoxyCompactList}\small\item\em Строка для описания окно ввода \end{DoxyCompactList}\end{DoxyCompactItemize}
